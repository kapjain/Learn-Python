...
l.insert(20,12)# if the given index in not there then this will add the element at the last position
...
#l.insert(4,range(2,3,0.1)) TypeError: 'float' object cannot be interpreted as an integer
# list(range(0,10,0.5)) TypeError: 'float' object cannot be interpreted as an integer
#l.insert() TypeError: insert() takes exactly 2 arguments (0 given)


#The extend(seq) method appends the contents of seq to list.
l = [0, 1, 2,]
l.extend((10,11,12))
...
#remove(object or value), object is mandatory parameter
l = [10, 8, 6, 4, 2]
l.remove(10)
print(l)#[8, 6, 4, 2]
...
#l.remove(30) ValueError: list.remove(x): x not in list
